...
namespace FRED
{
    public class ReleaseSeries : Request
    {
        ...
        public ReleaseSeries(string api_key, string release_id) : base("http://api.stlouisfed.org/fred/release/series?release_id=" + release_id + "&api_key=" + api_key) { }
