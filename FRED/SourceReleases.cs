...
namespace FRED
{
    public class SourceReleases : Request
    {
        ...
        public SourceReleases(string api_key, string source_id) : base("http://api.stlouisfed.org/fred/source/releases?source_id=" + source_id + "&api_key=" + api_key) { }
        public SourceReleases() { }
